...
const routes: Routes = [
  ...
  {path: 'users', component: CustomerListComponent, canActivate: [GlobalGuard], canLoad: [GlobalGuard]},
  {path: 'products', component: ProductTableComponent, canActivate: [GlobalGuard], canLoad: [GlobalGuard]}
];
